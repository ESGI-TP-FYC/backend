...
public class FilesStorageServiceImpl implements FilesStorageService {
    ...
    public FilesStorageServiceImpl(ApplicationConfiguration applicationConfiguration) {
        this.applicationConfiguration = applicationConfiguration;
        this.root= Paths.get(applicationConfiguration.getDocumentStorage().getUploadDirectory()).toAbsolutePath().normalize();
        try {
