...
public class TestConstants {
    ...
    public static final String PRODUCTR_CREED = "Creed";
    public static final String PRODUCTR_CHANEL = "Chanel";
    public static final String PRODUCT_TITLE = "Chanel N5";
    public static final Integer YEAR = 1921;
    public static final String COUNTRY = "France";
    public static final String PRODUCT_GENDER = "female";
    ...
    public static final String GRAPHQL_QUERY_PRODUCT = "{ product(id: 1) { id productTitle productr price } }";
}
